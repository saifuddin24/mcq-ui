...
function App() {
  ...
  function hideAllDropdowns() {
    Object.keys( dropdowns ).map( ( item ) => item = false )
  }


  const [userMenuVisible, setUserMenuVisible]= useState(false);
  const [vpClick, setViewPortClick ]= useState(false);
  ...
  return (
      <nav className="bg-gray-200" onClick={() => { hideAllDropdowns() }}>
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
          <div className="relative flex items-center justify-between h-16">
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              ...
              <UserMenu open={dropdowns.userMenuOpen} onMenuAction={(action) => {}}/>
        ...
        <div className="sm:block" id="main-menu-mobile" data-hidden='true'>
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:text-white hover:bg-gray-700">Team</a>
            <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:text-white hover:bg-gray-700">Projects</a>
            <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:text-white hover:bg-gray-700">Calendar</a>
          </div>
        </div>
      </nav>
...
function UserMenu({ open, onMenuAction }){
  const [userMenuVisible, setUserMenuVisible]= useState(false);


  function getIsVisible(){
    return userMenuVisible && open;
  }


  //setUserMenuVisible( vpClicked );
  //   onClick={ () => {
  //     setUserMenuVisible( !userMenuVisible );
  //     if( typeof onMenuAction === 'function' ) {
  //       onMenuAction( userMenuVisible );
  //     }
  //   }}
  ...
  return <div className="ml-3 relative">
    ...
    {/*<div className={ ( getIsVisible() ? '' : 'hidden' ) + ' origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5'} role="menu" aria-orientation="vertical" aria-labelledby="user-menu">*/}
    <div id="user-profile-menu" data-hidden className={'origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5'} role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
